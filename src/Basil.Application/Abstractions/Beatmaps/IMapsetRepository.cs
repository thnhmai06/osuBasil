...
{
	/// <summary>
	///     Fetches the mapset with the given id.
	/// </summary>
	/// <param name="id">The id of the set to find.</param>
	/// <param name="cancellationToken">A token that cancels the operation.</param>
	/// <returns>The matching mapset, or <see langword="null" /> when no such row exists.</returns>
	Task<Mapset?> FetchByIdAsync(int id, CancellationToken cancellationToken = default);

	/// <summary>
	///     Inserts or updates a mapset row and returns the row as persisted.
	/// </summary>
	/// <param name="mapset">The mapset to persist.</param>
	/// <param name="cancellationToken">A token that cancels the operation.</param>
	/// <returns>The persisted mapset.</returns>
	/// <remarks>
	...
	///     <see cref="Mapset.IsFrozen" />, <see cref="Mapset.IsPrivate" />, and media-file columns are
	...
	/// <summary>
	///     Deletes the mapset with the given id and every beatmap it owns.
	/// </summary>
	...
	/// <summary>
	///     Fetches every mapset id currently stored.
	/// </summary>
	/// <param name="cancellationToken">A token that cancels the operation.</param>
	/// <returns>Every mapset id in the database.</returns>
	/// <remarks>
	...
	///     <see langword="true" /> to exclude sets whose <see cref="Mapset.IsPrivate" /> flag is set;
	...
	/// <summary>
	///     Sets or clears the mapset's write-lock flag.
	/// </summary>
	...
	/// <summary>
	///     Sets or clears the mapset's privacy flag, hiding every beatmap under the set from
	...
	/// <summary>
	///     Sets the background image file name of the given mapset.
	/// </summary>
	/// <param name="id">The id of the set to update.</param>
	...
	/// <summary>
	///     Sets the audio file name of the given mapset.
	/// </summary>
	/// <param name="id">The id of the set to update.</param>
	...
	///     <see langword="true" /> to count every mapset including private ones; otherwise,
	///     <see langword="false" /> to count only public sets.
	/// </param>
	/// <param name="cancellationToken">A token that cancels the operation.</param>
	/// <returns>The requested mapset count.</returns>
	/// <remarks>
