...
///     BasilBot user (id=1).
/// </summary>
public class MySqlStatsRepositoryTests(MySqlFixture fixture) : IClassFixture<MySqlFixture>
{
    private readonly MySqlStatsRepository _repository = new(fixture.ConnectionString);
