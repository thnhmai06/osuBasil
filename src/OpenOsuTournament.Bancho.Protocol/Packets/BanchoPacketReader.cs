...
namespace OpenOsuTournament.Bancho.Protocol.Packets;
...
///     iteration/dispatch loop is wired up in OpenOsuTournament.Bancho.Web during Phase 3, once handlers exist).
