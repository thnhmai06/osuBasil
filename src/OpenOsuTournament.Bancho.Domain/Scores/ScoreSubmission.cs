...
/// <summary>
///     Ported from app/objects/score.py's Score. OpenOsuTournament.Bancho's no-pp scope means `pp`/`sr` fields are
...
///     cannot depend on OpenOsuTournament.Bancho.Application's PlayerSession; the orchestrating use case supplies them.
/// </summary>
