...
/// </summary>
public class MySqlScoreRepositoryTests(MySqlFixture fixture) : IClassFixture<MySqlFixture>
{
    private readonly MySqlScoreRepository _repository = new(fixture.ConnectionString);
