...
using Basil.Application.Unresolved.Bot;
using Basil.Application.Unresolved.Channels;
using Basil.Application.Unresolved.Chat;
using Basil.Application.Unresolved.Irc;
using Basil.Application.Unresolved.Multiplayer.Handlers.Countdown;
using Basil.Application.Unresolved.Multiplayer.Handlers.Lifecycle;
using Basil.Application.Unresolved.Multiplayer.Handlers.Slots;
	...
	ILogger<MatchControlService> matchControlLogger) : IMpCommandService
{
		...
		CancellationToken cancellationToken)
	{
		var beatmapLine = match.MapId is { } mapId
			? await beatmapRepository.SearchAsync(mapId, cancellationToken: cancellationToken) is { } bmap
		...
		// {
		// 	var user = await userRepository.SearchAsync(id, cancellationToken); // referee can be offline
