		...
		group.MapGet("/{userId:int}", (int userId, HttpContext context) =>
			{
				...
				{
					const string botResourceName = "Basil.Infrastructure.Resources.Avatars.basilbot.png";
				...
				// Regular user
				const string defaultResourceName = "Basil.Infrastructure.Resources.Avatars.default.png";
