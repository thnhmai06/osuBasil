...
namespace Basil.Infrastructure.Shared.Http.OpenApi;
...
internal static class EnvelopeSchemaTransformer
{
	...
	public static void AddEnvelopeSchemaTransformer(this OpenApiOptions options)
	{
		options.AddOperationTransformer((operation, context, _) =>
		{
			...
			// see SseEndpoints.SseError/NotLive), and it gets enveloped exactly like every other route's error response.
			var isSse = SseEndpoints.IsSseRoute(context.Description.RelativePath);
