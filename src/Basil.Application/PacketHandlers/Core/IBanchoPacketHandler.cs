...
///     <see cref="BanchoPacketReader" /> and performs the corresponding server work. Handlers are
...
public interface IBanchoPacketHandler
{
	...
	/// <summary>Gets a value that indicates whether this handler may run for a restricted player.</summary>
	/// <value>
	...
	/// <summary>Reads and processes one packet for the given player.</summary>
