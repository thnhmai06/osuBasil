	...
	IOptions<ServerOptions> server)
{
	...
	public async Task<MenuBanner?> ReplaceImageAsync(int id, Stream content, string extension, string? url = null,
		DateTime? begins = null, DateTime? expires = null, CancellationToken cancellationToken = default)
	{
