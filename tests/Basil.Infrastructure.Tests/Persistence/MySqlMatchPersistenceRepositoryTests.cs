...
public class MySqlMatchPersistenceRepositoryTests(MySqlFixture fixture) : IClassFixture<MySqlFixture>
{
    private static readonly DateTime FixedTime = new(2026, 1, 1, 12, 0, 0, DateTimeKind.Utc);
    private readonly MySqlMatchPersistenceRepository _repository = new(fixture.ConnectionString);
