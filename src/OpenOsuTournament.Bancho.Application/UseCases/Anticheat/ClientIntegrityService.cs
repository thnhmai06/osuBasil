...
namespace OpenOsuTournament.Bancho.Application.UseCases.Anticheat;
...
///     webhook side effects are all dropped, since OpenOsuTournament.Bancho has no restrict machinery yet (Phase 10
