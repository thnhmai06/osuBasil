...
/// <remarks>
///     Marks the player's slot as skipped and broadcasts a <c>MatchPlayerSkipped</c> packet for the
///     player to the match channel. When every slot that is still
...
public sealed class MatchSkipRequestHandler(MatchMembershipService matchMembership) : IBanchoPacketHandler
{
	...
	/// <summary>Processes the skip-request packet for the given player.</summary>
