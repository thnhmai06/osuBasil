...
using Basil.Application.Unresolved.Beatmaps;
...
/// </summary>
/// <remarks>
///     These payloads are deliberately cheaper than <c>MatchReportService</c>'s DB-backed
...
public static class MatchLiveSnapshotBuilder
{
	...
	/// <remarks>
	///     Both <c>GET /matches</c> list items and <c>MatchReportService</c>'s <c>Live</c>
...
///     (<see cref="MatchListItem" />, <c>MatchReport</c>) already carries
