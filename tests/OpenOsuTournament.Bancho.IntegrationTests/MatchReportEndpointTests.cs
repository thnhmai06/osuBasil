...
public class MatchReportEndpointTests : IClassFixture<WebApplicationFactory<Program>>
{
    ...
    {
        _matchPersistence.Match = new MatchRow(5, "Grand Finals", 0, 0, 0, 1, true,
    ...
    private sealed class StubScoreRepository : IScoreRepository
    {
        public Task<IReadOnlyList<BeatmapLeaderboardScoreRow>> FetchBeatmapLeaderboardScoresAsync(
            string mapMd5, OpenOsuTournament.Bancho.Domain.Beatmaps.GameMode mode, int userId, int? mods = null,
        ...
        public Task<PersonalBestLeaderboardScoreRow?> FetchPersonalBestLeaderboardScoreAsync(string mapMd5,
            OpenOsuTournament.Bancho.Domain.Beatmaps.GameMode mode, int userId,
            CancellationToken cancellationToken = default)
        {
            throw new NotSupportedException();
        }
        ...
        public Task<int> FetchPersonalBestLeaderboardRankAsync(string mapMd5,
            OpenOsuTournament.Bancho.Domain.Beatmaps.GameMode mode, long score,
            CancellationToken cancellationToken = default)
        {
            throw new NotSupportedException();
        }
        ...
        public Task MarkPreviousBestScoresSubmittedAsync(string mapMd5, int userId,
            OpenOsuTournament.Bancho.Domain.Beatmaps.GameMode mode, CancellationToken cancellationToken = default)
        {
            throw new NotSupportedException();
        }
    ...
    private sealed class StubMatchRegistry : IMatchRegistry
    {
        ...
        public MatchSession? GetById(int id) => null;
        public MatchSession? GetByDbId(int dbId) => null;
        public MatchSession? TryCreate(Func<int, MatchSession> factory) => null;
