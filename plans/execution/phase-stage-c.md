...
## Current task: C1a — step 3 (chat) in progress, commits 1–3 of 5 done
...
commits in its §4 order, one pinned row each, tree green after each: (1), (2) and (3) done, above; (3) `MpCommandService+ScopedDmReplySink`;
