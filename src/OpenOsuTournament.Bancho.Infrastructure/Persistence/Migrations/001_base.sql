-- OpenOsuTournament.Bancho schema. PascalCase tables/columns, ids AUTO_INCREMENT from 1.
...
(
    ...
    HostId           int         not null,
    HasPublicHistory boolean     default true not null,
...
values (1, 'BanchoBot', 'banchobot', 1, 'ca', 0, 'bot@localhost',
        '_______________________my_cool_bcrypt_______________________', UNIX_TIMESTAMP(), UNIX_TIMESTAMP());

insert into UserStats (Id, Mode) values (1, 0);
insert into UserStats (Id, Mode) values (1, 1);
insert into UserStats (Id, Mode) values (1, 2);
insert into UserStats (Id, Mode) values (1, 3);
insert into UserStats (Id, Mode) values (1, 4);
insert into UserStats (Id, Mode) values (1, 5);
insert into UserStats (Id, Mode) values (1, 6);
insert into UserStats (Id, Mode) values (1, 8);
