...
/// </summary>
public class MySqlScoreSubmissionPersistenceTests(MySqlFixture fixture) : IClassFixture<MySqlFixture>
{
    private readonly MySqlScoreSubmissionPersistence _persistence = new(fixture.ConnectionString);
