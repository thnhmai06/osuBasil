...
public class MySqlMailRepositoryTests(MySqlFixture fixture) : IClassFixture<MySqlFixture>
{
    private readonly MySqlMailRepository _repository = new(fixture.ConnectionString);
