...
{
    public async Task<ReplayFetchResult> FetchReplayFileAsync(long scoreId, int viewerId,
        CancellationToken cancellationToken = default)
    {
        ...
        if (data is null) return new ReplayFetchResult(ReplayFetchResultCode.NotFound, null);
