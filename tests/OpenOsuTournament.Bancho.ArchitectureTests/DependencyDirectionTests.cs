...
namespace OpenOsuTournament.Bancho.ArchitectureTests;
...
public class DependencyDirectionTests
{
    ...
    public void Domain_Should_Not_HaveDependencyOn_Infrastructure()
    {
        var result = Types.InAssembly(DomainAssembly)
            .Should()
            .NotHaveDependencyOn("OpenOsuTournament.Bancho.Infrastructure")
            .GetResult();
    ...
    public void Domain_Should_Not_HaveDependencyOn_Application()
    {
        var result = Types.InAssembly(DomainAssembly)
            .Should()
            .NotHaveDependencyOn("OpenOsuTournament.Bancho.Application")
            .GetResult();
    ...
    public void Domain_Should_Not_HaveDependencyOn_Web()
    {
        var result = Types.InAssembly(DomainAssembly)
            .Should()
            .NotHaveDependencyOn("OpenOsuTournament.Bancho.Web")
            .GetResult();
    ...
    public void Protocol_Should_Not_HaveDependencyOn_AnyOtherBanchoProject()
    {
        var result = Types.InAssembly(ProtocolAssembly)
            .Should()
            .NotHaveDependencyOnAny(
                "OpenOsuTournament.Bancho.Domain",
                "OpenOsuTournament.Bancho.Application",
                "OpenOsuTournament.Bancho.Infrastructure",
                "OpenOsuTournament.Bancho.Web")
            .GetResult();
