...
public static class MatchCreationDataMapper
{
	...
	///     <see langword="false" />.
	/// </returns>
	public static bool IsValid(MatchStatePacket data, int expectedHostId)
	{
		return data.HostId == expectedHostId && data.Name.Length <= MatchControlService.MaxMatchNameLength;
	}
