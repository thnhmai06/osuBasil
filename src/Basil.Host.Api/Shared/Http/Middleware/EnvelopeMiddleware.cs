...
namespace Basil.Host.Api.Shared.Http.Middleware;
...
///     skip-vs.-wrap (see <see cref="SseEndpoints.IsSseRoute" />). A file download's `Content-Type`
