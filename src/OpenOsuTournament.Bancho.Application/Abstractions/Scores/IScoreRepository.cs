...
///     this field `leaderboard_value` because it's pp for rx/ap and score for vanilla — OpenOsuTournament.Bancho's
...
///     reads the getscores endpoint needs. `scoring_metric` is dropped entirely from every method's
    ///     signature (compared to the Python source) — OpenOsuTournament.Bancho always ranks by raw score, never pp.
/// </summary>
public interface IScoreRepository
{
    ...
    ///     per OpenOsuTournament.Bancho's no-pp scope).
    /// </summary>
