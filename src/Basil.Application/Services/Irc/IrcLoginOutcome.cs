...
/// </remarks>
public sealed record IrcLoginOutcome(bool Success, IrcSession? Session, IReadOnlyList<IrcMessage> Messages)
{
	...
	public static IrcLoginOutcome Ok(IrcSession session, IReadOnlyList<IrcMessage> messages)
	{
