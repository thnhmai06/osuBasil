...
/// <summary>
///     The match state as produced by <see cref="BanchoPacketReader.ReadMatch" />. This is
///     intentionally a different shape than <see cref="MatchPacketData" /> (the write side): the wire
