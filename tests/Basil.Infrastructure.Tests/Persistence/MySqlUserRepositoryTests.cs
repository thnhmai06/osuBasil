...
/// </summary>
public class MySqlUserRepositoryTests(MySqlFixture fixture) : IClassFixture<MySqlFixture>
{
    private readonly MySqlUserRepository _repository = new(fixture.ConnectionString);
