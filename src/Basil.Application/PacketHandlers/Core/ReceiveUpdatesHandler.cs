...
///     accepted value is stored on <see cref="PlayerSession.PresenceFilter" />.
/// </remarks>
public sealed class ReceiveUpdatesHandler : IBanchoPacketHandler
{
	...
	/// <summary>Reads the filter value and stores it on the player's session when it is valid.</summary>
	/// <param name="player">The player session whose presence filter is being updated.</param>
