...
///     the player receives a <c>MatchJoinFail</c>. On success the creating player is added as the
...
public sealed class CreateMatchHandler(MatchMembershipService matchMembership) : IBanchoPacketHandler
{
	...
	/// <summary>Processes the create-match packet for the given player.</summary>
