...
public static class ScoreSubmissionResponseBuilder
{
    ...
    public static string BuildError(ScoreSubmissionResultCode code) => code switch
    {
        ...
        ScoreSubmissionResultCode.Success => throw new ArgumentException("Success is not an error code.", nameof(code)),
