...
public sealed class CategoryEnricher : ILogEventEnricher
{
	...
	[
		...
		("Basil.Infrastructure.Multiplayer.", true, "Matches"),
		("Basil.Infrastructure.Multiplayer.Packets.", true, "Matches"),
		("Basil.Infrastructure.Scores.", true, "Scores"),
		("Basil.Infrastructure.Auth.LoginService", false, "Online"),
		("Basil.Infrastructure.Shared.Sessions.PlayerLogoutService", false, "Online"),
		("Basil.Infrastructure.Irc.", true, "IRC"),
		("Basil.Infrastructure.Irc.", true, "IRC"),
		("Basil.Infrastructure.Irc.", true, "IRC"),
		("Basil.Infrastructure.Shared.Persistence.Repositories.", true, "Database"),
		("Basil.Infrastructure.Caching.", true, "Cache"),
		("Microsoft.Hosting.Lifetime", false, "Host"),
		("Basil.Host.Bootstrap", false, "Host"),
		("Host", false, "Host"),
		("Basil.Infrastructure.Shared.Http.Middleware.ApiRequestLoggingMiddleware", false, "Api")
	];
