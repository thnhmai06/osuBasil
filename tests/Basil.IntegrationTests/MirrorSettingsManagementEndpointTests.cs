...
/// </summary>
public class MirrorSettingsManagementEndpointTests : IClassFixture<WebApplicationFactory<Bootstrap>>
{
	private readonly WebApplicationFactory<Bootstrap> _factory;
	private readonly InMemorySettingsRepository _settings = new();

	public MirrorSettingsManagementEndpointTests(WebApplicationFactory<Bootstrap> factory)
	{
