...
///     these flags occupy higher bit shifts (14–22) and are dispatched via background telemetry calls outside score submissions.
/// </remarks>
[Flags]
public enum LastFmFlags : uint
{
    ...
    /// <summary>
    ///     Indicates <c>SDL2.dll</c> was loaded into memory (osu!stable does not use SDL2 natively; typically used by injection wrappers).
    /// </summary>
    Sdl2Library = 1 << 20,
    ...
    /// <summary>
    ///     Indicates memory or sound artifacts associated with the legacy AQN (Aoba Quality Network) cheat module were detected.
    /// </summary>
    AqnMenuSample = 1 << 22
}