...
public sealed class MySqlMapRepository(string connectionString) : IMapRepository
{
    ...
    public async Task<Beatmap?> FetchOneAsync(int? id = null, string? md5 = null, string? filename = null, int? setId = null, CancellationToken cancellationToken = default)
    {
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var mapsBySet = rows.Select(r => r.ToBeatmap()).GroupBy(b => b.SetId).ToDictionary(g => g.Key, g => (IReadOnlyList<Beatmap>)g.ToList());
