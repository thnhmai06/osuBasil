...
namespace Basil.Server.Shared.Logging;
...
public sealed class CategoryEnricher : ILogEventEnricher
{
	...
	[
		("Basil.Server.Features.Beatmaps.", true, "Beatmapsets"),
		("Basil.Server.Features.Multiplayer.", true, "Matches"),
		("Basil.Server.Features.Multiplayer.Packets.", true, "Matches"),
		("Basil.Server.Features.Scores.", true, "Scores"),
		("Basil.Server.Features.Auth.LoginService", false, "Online"),
		("Basil.Server.Shared.Sessions.PlayerLogoutService", false, "Online"),
		("Basil.Server.Features.Irc.", true, "IRC"),
		("Basil.Server.Features.Irc.", true, "IRC"),
		("Basil.Server.Features.Irc.", true, "IRC"),
