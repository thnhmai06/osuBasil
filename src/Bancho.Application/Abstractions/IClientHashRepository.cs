...
public sealed record ClientHash(int UserId, string OsuPath, string Adapters, string UninstallId, string DiskSerial, DateTime LatestTime, int Occurrences);

/// <summary>Ported from app/repositories/client_hashes.py's ClientHashWithPlayer dataclass.</summary>
public sealed record ClientHashWithPlayer(int UserId, string OsuPath, string Adapters, string UninstallId, string DiskSerial, DateTime LatestTime, int Occurrences, string Name, int Priv);
...
{
    Task<ClientHash> CreateAsync(int userId, string osuPath, string adapters, string uninstallId, string diskSerial, CancellationToken cancellationToken = default);
