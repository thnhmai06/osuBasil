...
public static class RankedStatusExtensions
{
    ...
    public static int OsuApi(this RankedStatus status) => status switch
    {
    ...
    public static RankedStatus FromOsuApi(int osuApiStatus) => osuApiStatus switch
    {
    ...
    public static RankedStatus FromOsuDirect(int osuDirectStatus) => osuDirectStatus switch
    {
