...
/// </summary>
public class MySqlChannelRepositoryTests(MySqlFixture fixture) : IClassFixture<MySqlFixture>
{
    private readonly MySqlChannelRepository _repository = new(fixture.ConnectionString);
