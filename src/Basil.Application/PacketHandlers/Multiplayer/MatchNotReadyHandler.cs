...
/// <summary>Handles the client's notification that the player is no longer ready.</summary>
/// <remarks>
///     Marks the player's slot as <see cref="Basil.Domain.Multiplayer.SlotStatus.NotReady" />. The
...
public sealed class MatchNotReadyHandler(MatchMembershipService matchMembership) : IBanchoPacketHandler
{
	...
	/// <summary>Processes the not-ready packet for the given player.</summary>
