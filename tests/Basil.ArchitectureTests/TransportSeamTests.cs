...
public class TransportSeamTests
{
	...
	public void Business_And_Api_Types_Should_Not_Reference_Protocol()
	{
		...
		[
			...
			"Basil.Server.Features.Multiplayer.Handlers.Lifecycle.AbortHandler",
