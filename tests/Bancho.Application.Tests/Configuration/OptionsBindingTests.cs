...
public class OptionsBindingTests
{
    ...
    {
        var options = BindOptions<AppOptions>(AppOptions.SectionName, new()
        {
    ...
    {
        var options = BindOptions<DatabaseOptions>(DatabaseOptions.SectionName, new()
        {
    ...
    {
        var options = BindOptions<RedisOptions>(RedisOptions.SectionName, new()
        {
    ...
    {
        var options = BindOptions<OsuApiOptions>(OsuApiOptions.SectionName, new());
    ...
    {
        var options = BindOptions<DatadogOptions>(DatadogOptions.SectionName, new()
        {
    ...
    {
        var options = BindOptions<PerformanceOptions>(PerformanceOptions.SectionName, new()
        {
    ...
    {
        var options = BindOptions<RegistrationOptions>(RegistrationOptions.SectionName, new()
        {
    ...
    {
        var options = BindOptions<CaptchaOptions>(CaptchaOptions.SectionName, new());
    ...
    {
        var options = BindOptions<WebSessionOptions>(WebSessionOptions.SectionName, new()
        {
    ...
    {
        var options = BindOptions<DiscordOptions>(DiscordOptions.SectionName, new()
        {
