	...
	ILogger<MatchControlService> logger)
{
		...
		CancellationToken cancellationToken = default)
	{
		...
		logger.LogDebug("Room settings changed: MatchId={MatchId} Visible={Visible}", match.DbId, isPrivate);
	...
	{
		var beatmap = await beatmapRepository.SearchAsync(beatmapId, cancellationToken: cancellationToken);
