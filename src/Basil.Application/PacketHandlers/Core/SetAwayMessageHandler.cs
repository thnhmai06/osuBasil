...
/// <summary>
///     Handles the SetAwayMessage packet, which stores an away message on the player's session.
/// </summary>
/// <remarks>
///     The body is an osu! chat message read via <see cref="BanchoPacketReader.ReadMessage" />; only
///     its text is kept and stored on <see cref="PlayerSession.AwayMessage" />.
/// </remarks>
public sealed class SetAwayMessageHandler : IBanchoPacketHandler
{
	...
	/// <summary>Reads the message and stores its text as the player's away message.</summary>
	/// <param name="player">The player session whose away message is being set.</param>
