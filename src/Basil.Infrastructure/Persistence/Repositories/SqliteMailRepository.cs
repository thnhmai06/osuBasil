...
public sealed class SqliteMailRepository(string connectionString) : IMailRepository
{
    public async Task<Mail> CreateAsync(int fromId, int toId, string msg, CancellationToken cancellationToken = default)
    {
        ...
        var id = await connection.ExecuteScalarAsync<int>(
            """
            INSERT INTO Mail (FromId, ToId, Msg, Time) VALUES (@FromId, @ToId, @Msg, unixepoch());
