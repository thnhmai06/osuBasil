...
/// client-facing protocol, not just internal self-consistency. See docs/csharp-migration-plan.md
/// Phase 6 notes for the oracle script.
/// </summary>
public class RijndaelScoreDecryptorTests
{
    ...
    public void Decrypt_MatchesPythonEncryptionOracle()
    {
        ...
        Assert.Equal(
            ["abc123checksum", "490", "5", "3", "0", "0", "1", "12345678", "500", "False", "S", "72", "True", "0", "210520235959", "20210520 "],
            fields);
