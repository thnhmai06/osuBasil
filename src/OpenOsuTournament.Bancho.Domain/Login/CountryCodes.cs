...
/// <summary>Ported verbatim from app/state/services.py's country_codes table.</summary>
public static class CountryCodes
{
    public static readonly IReadOnlyDictionary<string, int> ByAcronym = new Dictionary<string, int>
    {
