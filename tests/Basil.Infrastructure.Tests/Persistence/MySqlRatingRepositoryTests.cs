...
public class MySqlRatingRepositoryTests(MySqlFixture fixture) : IClassFixture<MySqlFixture>
{
    private readonly MySqlRatingRepository _repository = new(fixture.ConnectionString);
